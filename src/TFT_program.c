...
void HTFT_voidDisplayImage(u16 * Copy_pu16Image)
{
    ...
    {
        // Send MSB First
    	Local_u8DataH = (u8)(Copy_pu16Image[Local_u16LoopCounter] >> 8);

        // Send LSB Then
        Local_u8DataL = (u8)Copy_pu16Image[Local_u16LoopCounter];
        HTFT_voidSendData(Local_u8DataH);
        HTFT_voidSendData(Local_u8DataL);
    }
}
