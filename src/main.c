...
void main(void)
{
	...
	// Setup The SPI Pins
	MGPIO_voidSetPinMode(GPIO_PORTA, GPIO_PIN4, GPIO_AF); // PA4 (NSS1) To Be AF
	...
	MGPIO_voidSetAlternativeFunction(GPIO_PORTA, GPIO_PIN4, 5); // PA4 To operate as NSS1
